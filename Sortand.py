...
def filter_and_output(outboundlist, pricelist, refundablelist,
                      ...
                      userinptdptimebound1=-1, userinptdptimebound2=-1, userinptprice='lth'):
...
filter_and_output(outboundslists, pricelists, refundlists,
                  userinptrefundable='true', userinptairline='O2', userinptdptimebound1=9,
                  userinptdptimebound2=15, userinptprice='htl')
